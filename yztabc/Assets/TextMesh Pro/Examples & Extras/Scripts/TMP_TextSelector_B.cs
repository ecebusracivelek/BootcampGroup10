...
namespace TMPro.Examples
{
    ...
    public class TMP_TextSelector_B : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler, IPointerUpHandler
    {
        ...
        void RestoreCachedVertexAttributes(int index)
        {
            ...
            // Restore UV0S
            // UVS0
            var src_uv0s_raw = m_cachedMeshInfoVertexData[materialIndex].uvs0;
            Vector2[] src_uv0s = src_uv0s_raw.Select(v => new Vector2(v.x, v.y)).ToArray();
            var dst_uv0s_raw = m_TextMeshPro.textInfo.meshInfo[materialIndex].uvs0;
            Vector2[] dst_uv0s = dst_uv0s_raw.Select(v => new Vector2(v.x, v.y)).ToArray();
            dst_uv0s[vertexIndex + 0] = src_uv0s[vertexIndex + 0];
            dst_uv0s[vertexIndex + 1] = src_uv0s[vertexIndex + 1];
            dst_uv0s[vertexIndex + 2] = src_uv0s[vertexIndex + 2];
            dst_uv0s[vertexIndex + 3] = src_uv0s[vertexIndex + 3];
            // UVS2
            var src_uv2s_raw = m_cachedMeshInfoVertexData[materialIndex].uvs2;
            Vector2[] src_uv2s = src_uv2s_raw.Select(v => new Vector2(v.x, v.y)).ToArray();
            var dst_uv2s_raw = m_TextMeshPro.textInfo.meshInfo[materialIndex].uvs2;
            Vector2[] dst_uv2s = dst_uv2s_raw.Select(v => new Vector2(v.x, v.y)).ToArray();
            ...
            // UVS0
            var src_uv0s_raw_2 = m_cachedMeshInfoVertexData[materialIndex].uvs0;
            src_uv0s = src_uv0s_raw_2.Select(v => new Vector2(v.x, v.y)).ToArray();
            var dst_uv0s_raw_2 = m_TextMeshPro.textInfo.meshInfo[materialIndex].uvs0;
            dst_uv0s = dst_uv0s_raw_2.Select(v => new Vector2(v.x, v.y)).ToArray();
            dst_uv0s[lastIndex + 0] = src_uv0s[lastIndex + 0];
            dst_uv0s[lastIndex + 1] = src_uv0s[lastIndex + 1];
            dst_uv0s[lastIndex + 2] = src_uv0s[lastIndex + 2];
            dst_uv0s[lastIndex + 3] = src_uv0s[lastIndex + 3];
            // UVS2
            var src_uv2s_raw_2 = m_cachedMeshInfoVertexData[materialIndex].uvs2;
            src_uv2s = src_uv2s_raw_2.Select(v => new Vector2(v.x, v.y)).ToArray();
            var dst_uv2s_raw_2 = m_TextMeshPro.textInfo.meshInfo[materialIndex].uvs2;
            dst_uv2s = dst_uv2s_raw_2.Select(v => new Vector2(v.x, v.y)).ToArray();
