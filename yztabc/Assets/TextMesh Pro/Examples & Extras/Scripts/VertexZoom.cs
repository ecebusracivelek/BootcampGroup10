        ...
        IEnumerator AnimateVertexColors()
        {
            ...
            while (true)
            {
                ...
                for (int i = 0; i < characterCount; i++)
                {
                    ...
                    var sourceUVs0Raw = cachedMeshInfoVertexData[materialIndex].uvs0;
                    Vector2[] sourceUVs0 = sourceUVs0Raw.Select(v => new Vector2(v.x, v.y)).ToArray();
                    var destinationUVs0Raw = textInfo.meshInfo[materialIndex].uvs0;
                    Vector2[] destinationUVs0 = destinationUVs0Raw.Select(v => new Vector2(v.x, v.y)).ToArray();
                ...
                for (int i = 0; i < textInfo.meshInfo.Length; i++)
                {
                    ...
                    var uvs0Raw = textInfo.meshInfo[i].uvs0;
                    textInfo.meshInfo[i].mesh.uv = uvs0Raw.Select(v => new Vector2(v.x, v.y)).ToArray();
